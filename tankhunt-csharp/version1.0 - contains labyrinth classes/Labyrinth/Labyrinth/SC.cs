...
namespace Labyrinth
{
    public static class SC
    {
        ...
        /// </summary>       
        /// 
        public static Rectangle Camera_screen_rectangle { get; set; }
        ...
        /// <returns></returns>
        public static Vector2 GetSquarePosition(Vector2 absolute_position)
        {
            return new Vector2((float)Math.Floor(absolute_position.X / (float)square_size), (float)Math.Floor(absolute_position.Y / (float)square_size));
        }

        public static Vector2 GetAbsolutePosition(Vector2 square_position)
        {
            return square_position * square_size;
        }

        public static int GetSquarePosition(float position)
        {
            return (int)Math.Floor(position / (float)square_size);
        }
