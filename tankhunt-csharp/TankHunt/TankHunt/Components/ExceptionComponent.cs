...
namespace TankHunt
{
    ...
    public class ExceptionComponent : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public ExceptionComponent(TankHunt game)
            : base(game)
        {
            Tankhunt = game;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Tankhunt.spriteBatch.Draw(Alert_sprite, Alert_rectangle, Color.White);
            Tankhunt.spriteBatch.DrawString(Tankhunt.main_font, string.Format("An exception has been caught!\nPress esc to exit application or press enter to try to continue.\nException message:\n {0}\n\n Full exception message:\n {1}",
