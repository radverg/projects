...
namespace TankHunt
{
    ...
    public class TankDestroyAnimation : Animation
    {
            ...
            : base()
        {
            ...
            Tank_parts[0] = new Sprite(Tank_parts_textures[0], player.Position, new Vector2(Tank_parts_textures[0].Width, Tank_parts_textures[0].Height) * SC.resv_ratio, player.Color);
            ...
            Tank_parts[1] = new Sprite(Tank_parts_textures[1], player.Position + new Vector2(player.Size.X / 2, 0), new Vector2(Tank_parts_textures[1].Width, Tank_parts_textures[1].Height) * SC.resv_ratio, player.Color);
            ...
            Tank_parts[2] = new Sprite(Tank_parts_textures[2], player.Position + new Vector2(0, player.Size.Y / 2), new Vector2(Tank_parts_textures[2].Width, Tank_parts_textures[2].Height) * SC.resv_ratio, player.Color);
            ...
            Tank_parts[3] = new Sprite(Tank_parts_textures[3], player.Position + new Vector2(player.Size.X / 2, player.Size.Y / 2), new Vector2(Tank_parts_textures[3].Width, Tank_parts_textures[3].Height) * SC.resv_ratio, player.Color);
