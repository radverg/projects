...
namespace TankHunt
{
    public abstract class Weapon
    {
        ...
        public abstract IEnumerable<Shot> Shoot(RandomLevel level, TankPlayerSprite player);
        public abstract IEnumerable<Shot> NetShoot(Vector2 startup_pos, double angle, TankPlayerSprite owner, int shot_id, RandomLevel level);
    }
}
