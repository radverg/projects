...
class ExpressionEvaluator:
	...
	def _eval_priority3(self, expr):
		...
		# found error, this regexp starts after last find so "5m5m5" would be split like "5m5 m5" and evaluated as "5pm5 m5"
		# result: syntax error on single figure numbers surrounded by substraction such as "10-5-10"
		# solution: do it again this time with the other
		expr = re.sub(r'([0-9])m([0-9])', r'\1pm\2', expr)
